...
const LEGACY_LABELS = Object.fromEntries(LEGACY_CATEGORIES.map((c) => [c.key, c.label]))
...
function orderedCategories(bookmarks) {
...
export { LEGACY_CATEGORIES, categoryLabel, orderedCategories }
