...
const ROOT_CATEGORY: BookmarkCategory = '未分类'
...
export function parseBookmarksHtml(html: string): BookmarkImportItem[] {
  ...
  function walk(dl: Element, category: BookmarkCategory): void {
...
function nextSiblingDl(dt: Element): Element | null {
...
export function looksLikeBookmarksHtml(text: string): boolean {
